<template>
  <div class="statistics-list-n">
    <el-row>
      <el-col :span="5">
        <p class="word">开票金额(元)</p>
        <!-- <p class="num">{{ this.invoiceAmount }}</p> -->
        <p class="num">79n</p>
      </el-col>
      <el-col :span="4">
        <div class="line"></div>
      ...
      <el-col :span="5">
        ...
        <!-- <p class="num">{{ this.invoiceTaxAmount }}</p> -->
        <p class="num">3286</p>
      </el-col>
      <el-col :span="4">
        <div class="line"></div>
    ...
    <el-row>
      <el-col :span="5">
        ...
        <!-- <p class="num">{{ this.certifiedAmount }}</p> -->
        <p class="num">21515</p>
      </el-col>
      <el-col :span="4">
        <div class="line"></div>
      ...
      <el-col :span="5">
        ...
        <!-- <p class="num">{{ this.certifiedTaxAmount }}</p> -->
        <p class="num">12312</p>
      </el-col>
      <el-col :span="4">
        <div class="line"></div>
      ...
      <el-col :span="5">
        ...
        <!-- <p class="num">{{ this.certifiedNum }}</p> -->
        <p class="num">23521</p>
      </el-col>
    </el-row>
  </div>
